...
export default function page() {
  return (
    ...
    <p className='font-normal p-4'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Maiores deserunt ea, ullam maxime, quos atque voluptatibus officiis qui omnis repellendus animi labore suscipit in laborum quo illo exercitationem eveniet quam.</p>
    </div>
